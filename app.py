...
def run_pulse_logic():
    with st.status("🚀 Initializing Groww Pulse Pipeline...", expanded=True) as status:
        ...
        if success:
            ...
            st.warning("The report was generated, but the email failed to send. Check your SMTP settings.")
...
st.sidebar.info("Credentials are loaded from your `.env` file or Streamlit Secrets.")
